...
<CardGroup cols={3}>
  ...
  <Card title="Gateway Nanopayments" icon="bolt" href="/gateway/nanopayments/quickstarts/seller">
    High-frequency agentic payments with instant verification, batched
    settlement, and gas-free USDC at scale.
  </Card>
