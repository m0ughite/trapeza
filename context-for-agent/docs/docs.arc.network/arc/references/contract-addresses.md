...
| Contract           | Address                                                                                                                        | Notes                                                                                            |
| :----------------- | :----------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------- |
| **Memo**           | [`0x9702466268ccF55eAB64cdf484d272Ac08d3b75b`](https://testnet.arcscan.app/address/0x9702466268ccF55eAB64cdf484d272Ac08d3b75b) | Attaches memo metadata to contract calls. Emits `Memo` events with a sequential index.           |
| **Multicall3From** | [`0xEb7cc06E3D3b5F9F9a5fA2B31B477ff72bB9c8b6`](https://testnet.arcscan.app/address/0xEb7cc06E3D3b5F9F9a5fA2B31B477ff72bB9c8b6) | Batches multiple calls like Multicall3, but preserves the original `msg.sender` in each subcall. |
